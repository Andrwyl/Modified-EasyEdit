    ...
    def edit(self,
        ...
        for i, request in enumerate(requests):
            ...
            if self.alg_name == 'IKE':
                ...
                edited_model, weights_copy, refined_neurons = self.apply_algo(
                    self.model,
                    self.tok,
                    [request],
                    self.hparams,
                ...
                #store refined_neurons
                with open('/u/andrewliu/EasyEdit/probing-project/results/kn/' + name + '.json', 'w') as to_dump:
                    json.dump(refined_neurons, to_dump)
